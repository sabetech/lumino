                ...
                <div class="panel panel-default">
                    <div class="panel-body tabs">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="#pilltab1" data-toggle="tab">Pillar Lecture Attendance</a></li>
                            <li class=""><a id="pillar_export" href="">Export</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="pilltab1">
                                <table class="table" id="pillar-lecture-table">
                                    <thead>
                                        <tr>
